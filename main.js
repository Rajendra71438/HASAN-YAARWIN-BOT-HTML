...
function renderSplash(){
  ...
  return `<div id="splash">
    ...
    <div class="splash-top" style="animation:fadeDown .6s ease-out both">
      ...
      <div class="splash-title">YAARWIN<br>Sureshot</div>
  ...
  return `<div class="screen">
    <div class="topbar">
      <div class="logo-wrap" id="logo-trigger">
        ...
        <div>
          <div class="logo-name">Yaarwin</div>
    ...
    <div class="info-card" style="animation:fadeUp .45s ease-out .08s both">
      ...
      <div class="info-title">🏆 Yaarwin Prediction Bot</div>
...
function renderUid(){
  ...
  return `<div class="screen">
    ...
    <div class="uid-card" style="animation:fadeUp .4s ease-out both">
      ...
      <button class="reg-btn" onclick="window.open('https://www.yaarwin0.com/#/register?invitationCode=127571920010','_blank')">
  ...
  return `<div class="screen">
    ...
    <div class="reason-list" style="animation:fadeUp .4s ease-out .1s both">
      ${lock?`
        ...
        <div class="reason-item"><div class="reason-emoji">💬</div><div class="reason-txt">Contact admin to unbind: <strong>@hasanbhai</strong></div></div>
      `:`
